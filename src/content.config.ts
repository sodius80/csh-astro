...
const reviews = defineCollection({
  ...
  schema: z.object({
    ...
    schemaPolicy: z.literal('evidence-linked-v1').optional(),
    ...
    decision: z.object({
      ...
      biggestCatch: z.string(),
      userSignal: z.string(),
      nextStep: z.string(),
      pricingNote: z.string().optional(),
    }).optional(),
    relatedReviews: z.array(z.string()).default([]),
    schemaProductUrl: z.string().url().optional(),
    schemaPricingUrl: z.string().url().optional(),
    schemaApplicationSubCategory: z.string().optional(),
    schemaOperatingSystem: z.string().optional(),
