...
startingPrice: "Free Basic Plan; Pro 30-day trial then annual subscription (volume-based); Custom and Enterprise custom quote; ads from $499/mo"
...
faqs:
  - { q: "What does Houzz Pro cost in 2026?", a: "Houzz Pro offers a Free Basic Plan with 3D floor planner, estimates, and invoicing. The Pro plan is available through a 30-day free trial that converts to an annual subscription. Additional users on the Custom tier are $60/user/month. Advertising packages start at $499/month and are separate from the software subscription." }
...
The $249/month figure that appears on some comparison sites is outdated. As of 2026, the official Houzz Pro pricing page no longer shows that number. The current structure uses a trial-first model that converts to an annual subscription. Here is how the tiers break down:

| Plan | Core Features Included | Pricing |
|---|---|---|
| Free Basic | 3D Floor Planner, Estimates, Invoicing | Free, no credit card required |
| Pro | CRM, Client Portal, Mobile App, QuickBooks Sync, Gusto, Zapier, Estimates, Invoicing | 30-day free trial; then annual subscription (est. ~$399/mo); volume-based up to $500K APV; 1 seat included |
