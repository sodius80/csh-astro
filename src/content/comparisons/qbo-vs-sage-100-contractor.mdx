...
vendorA:
  ...
  startingPrice: "No-monthly-subscription starter tier; paid from $38/mo Simple Start"
...
atAGlance:
  ...
  - ["Starting price", "No-monthly-subscription starter tier; paid core plans from $38/mo Simple Start", "Custom quote only; Sage uses Request info, phone, and expert contact paths"]
...
products:
  - name: "QuickBooks Online"
    slug: "quickbooks-online"
    pricingStart: "No-monthly-subscription starter tier; paid from $38/mo Simple Start; Plus $115/mo"
