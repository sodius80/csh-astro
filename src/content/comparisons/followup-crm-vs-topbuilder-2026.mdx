...
vendorB:
  ...
  startingPrice: "Request-only pricing; free trial available; G2 reports $35–90/user/month (unverified)"
shortAnswer:
...
atAGlance:
  - ["Starting price", "~$4,500/yr (5 users) + 20% setup fee", "Request-only; G2 reports $35–90/user/mo"]
  - ["Per-user cost", "~$75/user/month", "Request-only (G2 reports $35–90/mo)"]
...
products:
  ...
  - name: "TopBuilder"
    slug: "topbuilder"
    pricingStart: "Request-only; free trial available; G2 reports $35–90/user/month (unverified)"
