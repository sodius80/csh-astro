...
vendorB:
  ...
  startingPrice: "Quote required; implementation scoped separately"
...
atAGlance:
  ...
  - ["Starting price", "$35/mo Simple Start; Plus at ~$110/mo", "Quote required"]
...
| --- | --- | --- |
| Best fit | Small electrical contractors and trades businesses | Mid-size electrical contractors with complex job-costing needs |
| Pricing posture | $35–$235/mo; Plus at ~$110/mo | Quote required; implementation scoped separately |
...
Pricing is less transparent. Sage 100 Contractor pricing requires a custom quote, and implementation or optional cloud hosting can add meaningful cost. Because exact rates are not published, confirm modules, user counts, hosting, implementation, support, and renewal terms directly with Sage or an authorized reseller.
