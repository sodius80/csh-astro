...
vendorA:
  ...
  startingPrice: "Custom quote; verify current package and annual terms with sales"
...
vendorB:
  ...
  startingPrice: "No longer available; legacy pricing no longer current"
shortAnswer:
...
atAGlance:
  ...
  - ["Pricing model", "Volume-based custom quotes", "Legacy product; not available to new buyers"]
  - ["Starting price", "Custom quote", "No longer available"]
  - ["Onboarding", "Confirm setup scope with sales", "Legacy only"]
...
products:
  - name: "Buildertrend"
    slug: "buildertrend"
    pricingStart: "Custom quote; verify current package and annual terms with sales"
