...
atAGlance:
  ...
  - [Per-user cost, "$50-80/mo + $5-10/emp (Payroll)", "None (unlimited users on every plan)"]
  - [Payroll, "Built-in ($50-80/mo + $5-10/employee)", "None native (Gusto, ADP, etc. via integration)"]
  - [Job costing / project tracking, "Plus plan and up ($115/mo)", "Established plan ($90/mo)"]
  ...
  - [Multi-currency, "Advanced ($275/mo)", "Early and up (all plans)"]
...
| --- | --- | --- |
|| Starting price | $38/mo Simple Start (1 user) | $25/mo Early (20 invoices/mo) |
|| Most-used plan | Plus $115/mo (5 users) | Growing $55/mo (unlimited invoices) |
| Free trial | 30 days | 30 days |
|| Per-user costs | $50-80/mo + $5-10/emp (Payroll); tier pricing by user count | No per-user fees (unlimited users on every plan) |
...
|| Multi-currency | Advanced plan only ($275/mo) | All plans (Early and up) |
...
QuickBooks Online restricts multi-currency to the Advanced plan at $275/mo. That is a steep jump from Plus at $115/mo just to handle a few foreign transactions. For contractors who rarely deal with international currency, this does not matter. For those who do, it is a pricing problem.
...
QuickBooks Online can be the wrong fit when you have many users - the per-user pricing on payroll and the tiered user caps make larger teams expensive. It can also feel limiting for contractors who want clean multi-currency support without jumping to the $275/mo Advanced plan. And if you prefer a best-of-breed tools approach rather than the Intuit ecosystem, QBO's integration friction with non-Intuit tools can be frustrating.
