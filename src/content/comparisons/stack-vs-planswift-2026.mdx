...
atAGlance:
  ...
  - ["Starting price", "$84–$150/user/mo; ~$2,599/yr", "$2,000/year Professional subscription"]
...
| --- | --- | --- |
| Best fit | Contractors with remote estimators or teams needing cloud collaboration | Solo estimators and small shops wanting desktop speed and a perpetual license |
| Pricing posture | $84–$150/user/mo; ~$2,599/yr | $2,000/year Professional subscription |
...
With STACK, canceling the subscription typically means losing access to the cloud platform and project data unless an export is performed beforehand. STACK allows exports, but the workflow should be tested during the trial. With PlanSwift, the perpetual license means the software continues to work even if support lapses, but updates, bug fixes, and new plugins stop. Project files remain on the local machine regardless of support status.
